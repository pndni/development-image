...
RUN /opt/pyenv/bin/pip install numpy
RUN /opt/pyenv/bin/pip install scipy
RUN /opt/pyenv/bin/pip install bids-validator
RUN /opt/pyenv/bin/pip install pybids
RUN /opt/pyenv/bin/pip install heudiconv
RUN /opt/pyenv/bin/pip install nibabel
RUN /opt/pyenv/bin/pip install nipype
